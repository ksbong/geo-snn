...
info = valid_results[0][2] # 첫 번째 피험자의 info 사용
...
# =========================================================
print("\n⚙️ 글로벌 피쳐 추출 및 계산 중... (Raw Variance vs Riemannian Log-Cov)")
...
feat_proposed = extract_riemannian_log_cov(X_raw)

# =========================================================
# 3. 📊 통계적 검증 (F-value & LDA)
# =========================================================
print("⚙️ 글로벌 분별력 계산 및 교차 검증 중...")
...
print("\n" + "="*65)
print("🚀 GLOBAL Feature Test Results (105 Subjects, 4-Class)")
print("="*65)
